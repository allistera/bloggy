...
This follows on from my [adventures](/blog/self-hosted-ai-developer-stack) in trying to centralise my AI stack, making it easier to jump between Claude, Chat-GPT or Cursor.
